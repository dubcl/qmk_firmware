...
//                 KC_LGUI, MO(1), KC_SPC,     KC_SPC, MO(2), KC_RALT,
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LSFT,  KC_NO,  KC_NO,  KC_NO ,  KC_NO ,  KC_NO ,                       KC_HOME,   KC_NO,   KC_NO,   KC_UP,   KC_NO,  KC_PGUP, \
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LCTL,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,                           KC_END,  KC_NO,  KC_LEFT,  KC_DOWN, KC_RGHT, KC_PGDN, \
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
...
// KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5,           KC_6, KC_7, KC_8, KC_9, KC_0, KC_DEL, 
// KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,     KC_NO, KC_NO, KC_NO, KC_UP, KC_NO, KC_PGUP, 
// KC_LCTL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,     KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, 
//                     KC_LGUI, KC_TRNS, KC_SPC,   KC_SPC, MO(3), KC_RALT
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LGUI, LOWER, KC_SPC,       KC_SPC, KC_TRNS, LCTL(KC_LALT)
  //                                    |--------+--------+--------|  |--------+--------+-------------|
  ),
...
// KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,              KC_MINS,  KC_EQL,  KC_LBRC,  KC_RBRC,  KC_BSLS,  KC_GRV,  
// KC_F7,  KC_F8,  KC_F9,  KC_F10,  KC_F11,  KC_F12,           KC_UNDS,  KC_PLUS,  KC_LCBR,  KC_RCBR,  KC_PIPE,  KC_TILD,  
//                         KC_LGUI,  MO(3),  KC_SPC,           KC_SPC,  KC_TRNS,  LCTL(KC_LALT)

  [_ADJUST] = LAYOUT(
  //|-----------------------------------------------------|                    |-----------------------------------------------------|
      RESET ,  KC_NO ,  KC_NO ,  KC_NO ,  KC_NO ,  KC_NO ,                        KC_NO ,  KC_NO ,  KC_NO ,  KC_NO ,  KC_NO ,  KC_VOLU ,\
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      RGB_TOG ,  RGB_HUI ,  RGB_SAI ,  RGB_VAI ,  KC_NO ,  KC_NO ,                KC_NO ,  KC_NO ,  KC_NO ,  KC_NO ,  KC_NO ,  KC_VOLD ,  \
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  ...
  switch (biton32(layer_state)) {
    ...
    default:
        if (host_keyboard_leds() & (1<<USB_LED_CAPS_LOCK)) {
                  for (int i = 0; i < DRIVER_LED_TOTAL; i++) {
          rgb_matrix_set_color(i, 176, 144, 227);
      }
       }
      break;
  }
